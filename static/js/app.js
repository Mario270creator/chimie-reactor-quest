    ...
    return `
      <div class="builder-item" data-question-item>
        ...
        <div class="stack-form">
          <label><span>Enunț</span><input type="text" data-q-text data-chem-editor placeholder="Scrie întrebarea (ex: Câți atomi de H are H₂SO₄?)" required></label>
          <div class="builder-options">
            <label><span>Opțiunea 1</span><input type="text" data-q-option="0" data-chem-editor required></label>
            <label><span>Opțiunea 2</span><input type="text" data-q-option="1" data-chem-editor required></label>
            <label><span>Opțiunea 3</span><input type="text" data-q-option="2" data-chem-editor required></label>
            <label><span>Opțiunea 4</span><input type="text" data-q-option="3" data-chem-editor required></label>
          </div>
          <label>
          ...
          <label><span>Explicație</span><textarea rows="3" data-q-explanation data-chem-editor placeholder="De ce acesta este răspunsul corect?"></textarea></label>
        </div>
      </div>
    `;
  }
